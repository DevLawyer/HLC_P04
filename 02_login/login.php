        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex me-4" action="../03_signup/signup.php">
                ...
                <article class="col-md-4 card text-center bg-transparent border-0 h-50 d-block">
                    ...
                    <p class="card-body">
                        <form class="card-text" method="post" action="../07_php/login.php">
                            ...
                            <div class="input-group mt-2 fg-main">
                                <p>
                                    <button type="submit" id="submit" name="submit" class="btn btn-light bg-btn-1 btn-2 me-2" >Log In</button>
                                    Already have an account? <i class='bx bx-user-plus'></i> <a href="../03_signup/signup.php"> Sign Up</a>
                                </p>
                            </div>
                        </form>
                    </p>
